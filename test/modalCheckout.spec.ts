...
describe('ModalCheckout', () => {
  describe('#constructor()', () => {
    it('creates one style sheet', () => {
      ...
      const styleElements = document.querySelectorAll<HTMLStyleElement>('style[bc-style]')
    ...
    it('creates iframe container, overlay container, backdrop, and focus traps', async () => {
      ...
      expect(iframeContainer.classList.contains(Style.IframeContainer)).to.equal(true)
      expect(overlayContainer.classList.contains(Style.OverlayContainer)).to.equal(true)
  ...
  describe('#show()', () => {
    it('displays overlay and resolves upon animation finish', async () => {
      ...
      expect(overlayContainer.classList.contains(Style.EnterActive)).to.equal(false)
      ...
      expect(overlayContainer.classList.contains(Style.EnterActive)).to.equal(true)
  ...
  describe('#hide()', () => {
    it('hides overlay and resolves upon animation finish', async () => {
      ...
      expect(overlayContainer.classList.contains(Style.LeaveActive)).to.equal(false)
      ...
      expect(overlayContainer.classList.contains(Style.LeaveActive)).to.equal(true)
